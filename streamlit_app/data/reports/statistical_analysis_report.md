...
All results computed by `src/stats/statistical_analysis.py` against the actual warehouse data — every number below is reproducible by re-running that script.
