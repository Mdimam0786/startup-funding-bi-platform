...
I built three use cases here, each with model comparison, cross-validation, and — where it made sense — hyperparameter tuning and SHAP explainability. Every metric below comes from an actual model run (`src/ml/*.py`), nothing is estimated.
